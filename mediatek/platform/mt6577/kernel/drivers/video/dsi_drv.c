...
//added by xiewei for lcd esd recover -- begin
static void jrd_esd_WaitForEngineNotBusy(void)
{
    int timeOut;
#if ENABLE_DSI_INTERRUPT
    long int time;
    static const long WAIT_TIMEOUT = 10;    // 100ms
#endif
...
//added by xiewei for lcd esd recover -- end
...
//added by xiewei for lcd esd recover -- begin
DSI_STATUS jrd_esd_DSI_WaitForNotBusy(void)
{
    jrd_esd_WaitForEngineNotBusy();
