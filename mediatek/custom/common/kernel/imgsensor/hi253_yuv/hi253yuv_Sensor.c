...
HI253WriteCmosSensor(0x90, 0x0e); //BLC_TIME_TH_ON
HI253WriteCmosSensor(0x91, 0x0e); //BLC_TIME_TH_OFF 
...
//Normal BLC
HI253WriteCmosSensor(0xa8, 0x03);
HI253WriteCmosSensor(0xaa, 0x03);
HI253WriteCmosSensor(0xac, 0x03);
HI253WriteCmosSensor(0xae, 0x03);
/////// PAGE 2 START ///////
...
HI253WriteCmosSensor(0x2e, 0x00);	//11	
HI253WriteCmosSensor(0x2f, 0x00);	//a1	
...
HI253WriteCmosSensor(0x51, 0x03);	//00	don't touch 
...
HI253WriteCmosSensor(0xd4, 0x0e); //DCDC_TIME_TH_ON  don't touch
HI253WriteCmosSensor(0xd5, 0x0e); //DCDC_TIME_TH_OFF don't touch
HI253WriteCmosSensor(0xd6, 0x78); //DCDC_AG_TH_ON      78
HI253WriteCmosSensor(0xd7, 0x70); //DCDC_AG_TH_OFF     70
...
HI253WriteCmosSensor(0x13, 0x0a);//add jacky open constrast
...
HI253WriteCmosSensor(0x48, 0x88);
HI253WriteCmosSensor(0x60, 0x67);//6b AG ratio  jacky
HI253WriteCmosSensor(0x61, 0x90); //7e //8e //88 //70//88
HI253WriteCmosSensor(0x62, 0x90); //7e //8e //88 //80//88
...
HI253WriteCmosSensor(0x20, 0x04);//add jacky white
...
//Dark1 th
HI253WriteCmosSensor(0x52, 0x00); //b0
HI253WriteCmosSensor(0x53, 0x50); //60
HI253WriteCmosSensor(0x54, 0xd4); //c0
HI253WriteCmosSensor(0x55, 0xc0); //c0
HI253WriteCmosSensor(0x56, 0x70); //b0
HI253WriteCmosSensor(0x57, 0xec); //70
//Dark2 th
HI253WriteCmosSensor(0x58, 0x60); //90
HI253WriteCmosSensor(0x59, 0x40); //
HI253WriteCmosSensor(0x5a, 0xd0); 
HI253WriteCmosSensor(0x5b, 0xd0); 
HI253WriteCmosSensor(0x5c, 0xc0); 
HI253WriteCmosSensor(0x5d, 0x9b); //70
//Dark3 th
...
HI253WriteCmosSensor(0x90, 0x5d); //For capture 5d
...
HI253WriteCmosSensor(0xBD, 0x00);	//14	
...
HI253WriteCmosSensor(0x5d, 0x0c);
...
HI253WriteCmosSensor(0x20, 0x80); //X 60 //a0
...
HI253WriteCmosSensor(0x40, 0x5e); //0x48//65//5c
HI253WriteCmosSensor(0x50, 0x4a); //0x34
HI253WriteCmosSensor(0x60, 0x46); //0x29
HI253WriteCmosSensor(0x70, 0x4a); //0x34
/////// PAGE 15 START ///////
...
HI253WriteCmosSensor(0x14, 0x42);	//CMCOFSGH 
HI253WriteCmosSensor(0x15, 0x32);	//CMCOFSGM
HI253WriteCmosSensor(0x16, 0x24);	//CMCOFSGL
HI253WriteCmosSensor(0x17, 0x2f);	//CMC SIGN
//CMC

HI253WriteCmosSensor(0x30, 0x8b);
HI253WriteCmosSensor(0x31, 0x5c);
HI253WriteCmosSensor(0x32, 0x11);
HI253WriteCmosSensor(0x33, 0x17);
HI253WriteCmosSensor(0x34, 0x62);
HI253WriteCmosSensor(0x35, 0x0b);
HI253WriteCmosSensor(0x36, 0x09);
HI253WriteCmosSensor(0x37, 0x3e);
HI253WriteCmosSensor(0x38, 0x87);
//CMC OFS
HI253WriteCmosSensor(0x40, 0x9d);
HI253WriteCmosSensor(0x41, 0x2b);
HI253WriteCmosSensor(0x42, 0x8c);
HI253WriteCmosSensor(0x43, 0x0c);
HI253WriteCmosSensor(0x44, 0x98);
HI253WriteCmosSensor(0x45, 0x0b);
HI253WriteCmosSensor(0x46, 0x02);
HI253WriteCmosSensor(0x47, 0xa3);
...
HI253WriteCmosSensor(0x18, 0x5e);//AG_ON
HI253WriteCmosSensor(0x19, 0x5d);//AG_OFF
...
HI253WriteCmosSensor(0x33, 0x28);
HI253WriteCmosSensor(0x34, 0x53);
HI253WriteCmosSensor(0x35, 0x76);
HI253WriteCmosSensor(0x36, 0x91);
HI253WriteCmosSensor(0x37, 0xa3);
HI253WriteCmosSensor(0x38, 0xb4);
HI253WriteCmosSensor(0x39, 0xc0);
HI253WriteCmosSensor(0x3a, 0xc9);
HI253WriteCmosSensor(0x3b, 0xd2);
HI253WriteCmosSensor(0x3c, 0xd9);
HI253WriteCmosSensor(0x3d, 0xdf);
HI253WriteCmosSensor(0x3e, 0xe6);
HI253WriteCmosSensor(0x3f, 0xea);
HI253WriteCmosSensor(0x40, 0xef);
HI253WriteCmosSensor(0x41, 0xf5);
...
HI253WriteCmosSensor(0x72, 0x16);
HI253WriteCmosSensor(0x73, 0x2e);
HI253WriteCmosSensor(0x74, 0x54);
HI253WriteCmosSensor(0x75, 0x75);
HI253WriteCmosSensor(0x76, 0x90);
HI253WriteCmosSensor(0x77, 0xa7);
HI253WriteCmosSensor(0x78, 0xb6);
HI253WriteCmosSensor(0x79, 0xc2);
HI253WriteCmosSensor(0x7a, 0xca);
HI253WriteCmosSensor(0x7b, 0xd2);
HI253WriteCmosSensor(0x7c, 0xd9);
HI253WriteCmosSensor(0x7d, 0xdf);
HI253WriteCmosSensor(0x7e, 0xe6);
HI253WriteCmosSensor(0x7f, 0xea);
HI253WriteCmosSensor(0x80, 0xef);
HI253WriteCmosSensor(0x81, 0xf5);
...
HI253WriteCmosSensor(0x2b, 0x34); //f4->Adaptive on //04 off
...
//HI253WriteCmosSensor(0x70, 0x88); //6e
//medify by zhaojr
//Automatic exposure is too high resolving normal photographs
HI253WriteCmosSensor(0x70, 0x88); //80
//end medify by zhaojr
...
HI253WriteCmosSensor(0x9c, 0x19); //EXP Limit 500.00 fps 
HI253WriteCmosSensor(0x9d, 0x64); 
...
HI253WriteCmosSensor(0xb2, 0xa0);//a0
...
HI253WriteCmosSensor(0x01, 0x50); // Sleep Off
  #else
  HI253WriteCmosSensor(0x01, 0xf9); // Sleep ON
  HI253WriteCmosSensor(0x08, 0x0f); // Hi-Z ON
  HI253WriteCmosSensor(0x01, 0xf8); // Sleep OFF
  ...
  HI253WriteCmosSensor(0xb2, 0xa0); // AGMAX  //80
...
void HI253InitPara(void)
{
  ...
  HI253Status.PvDummyPixels = 360;//424;
  HI253Status.PvDummyLines = 20;//62;
...
void HI253NightMode(kal_bool Enable)
{
  ...
  if(HI253Status.MiniFrameRate = Enable)
   {
   HI253WriteCmosSensor(0x83, 0x09); // EXPTIMEH max fps
   HI253WriteCmosSensor(0x84, 0xeb); // EXPTIMEM
   HI253WriteCmosSensor(0x85, 0x10); // EXPTIMEL
   HI253WriteCmosSensor(0x88, 0x09); // EXPMAXH min fps init 5fps
   HI253WriteCmosSensor(0x89, 0xeb); // EXPMAXM
   HI253WriteCmosSensor(0x8a, 0x10); // EXPMAXL
   }
  else

     {
   HI253WriteCmosSensor(0x83, 0x04); // EXPTIMEH max fps
   HI253WriteCmosSensor(0x84, 0xf5); // EXPTIMEM
   HI253WriteCmosSensor(0x85, 0x88); // EXPTIMEL
   HI253WriteCmosSensor(0x88, 0x04); // EXPMAXH min fps init 10fps
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  HI253SetPage(0x00); 
  HI253WriteCmosSensor(0x10, 0x11); //13
  HI253WriteCmosSensor(0x12, 0x04); 
  HI253WriteCmosSensor(0x20, 0x00); // WINROWH
  HI253WriteCmosSensor(0x21, 0x04); // WINROWL
  HI253WriteCmosSensor(0x22, 0x00); // WINCOLH
  ...
  HI253SetPage(0x12);
  HI253WriteCmosSensor(0x20, 0x0f);//00
  HI253WriteCmosSensor(0x21, 0x0f);//00
  HI253WriteCmosSensor(0x90, 0x5d);  //00 
  HI253SetPage(0x13);
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
  ...
  pSensorInfo->SensorVideoFrameRate=12;
...
BOOL HI253SetWb(UINT16 Para)
{
  ...
  switch (Para)
  {
    ...
    case AWB_MODE_AUTO:
      ...
      HI253WriteCmosSensor(0x83, 0x59);
      HI253WriteCmosSensor(0x84, 0x14);
      HI253WriteCmosSensor(0x85, 0x5b);
      HI253WriteCmosSensor(0x86, 0x24);  
      break;
...
BOOL HI253SetExposure(UINT16 Para)
{
 // kal_uint32 temp;
  ...
  switch (Para)
  {
	case AE_EV_COMP_n15:              /* EV -1.5 */
      HI253WriteCmosSensor(0x40,0xe0);
      break;
	case AE_EV_COMP_n13:			/* EV -1.3 */
      HI253WriteCmosSensor(0x40,0xb8);//c8
      break;             
    case AE_EV_COMP_n10:              /* EV -1.5 */
      HI253WriteCmosSensor(0x40,0xb0);
      //temp = HI253ReadShutter();
	  //printk("AE_EV_COMP_n10:HI253ReadShutter:%d\n\r",temp);
      break;
    ...
    case AE_EV_COMP_00:                /* EV 0 */
      HI253WriteCmosSensor(0x40,0x88); //85
      //temp = HI253ReadShutter();
	  //printk("AE_EV_COMP_00:HI253ReadShutter:%d\n\r",temp);
      break;
    case AE_EV_COMP_03:              /* EV +0.5 */
      HI253WriteCmosSensor(0x40,0x18);
      break;
    case AE_EV_COMP_07:              /* EV +1 */
      HI253WriteCmosSensor(0x40,0x20);//30
      break;
    case AE_EV_COMP_10:              /* EV +1.5 */
      HI253WriteCmosSensor(0x40,0x25);//30
      //temp = HI253ReadShutter();
	  //printk("AE_EV_COMP_10:HI253ReadShutter:%d\n\r",temp);
      break;
    case AE_EV_COMP_13:              /* EV +2 */
      HI253WriteCmosSensor(0x40,0x38);//48
      break;
    case AE_EV_COMP_15:              /* EV +1.5*/
...
UINT32 HI253YUVSetVideoMode(UINT16 FrameRate)
{
  ...
  */
  HI253WriteCmosSensor(0x83, 0x03); // EXPTIMEH max fps
  HI253WriteCmosSensor(0x84, 0xf7); // EXPTIMEM
  HI253WriteCmosSensor(0x85, 0xa0); // EXPTIMEL
  ...
  HI253WriteCmosSensor(0x93,0x9e); // EXPMAXL  
  HI253WriteCmosSensor(0x01, 0xf8); // Sleep OFF
  spin_lock(&hi253_drv_lock);
  HI253Status.AECTL1 |= 0x80;
  spin_unlock(&hi253_drv_lock);
...
static void HI253GetEvAwbRef(UINT32 pSensorAEAWBRefStruct/*PSENSOR_AE_AWB_REF_STRUCT Ref*/)
{
    ...
    #if 1
	/*Ref->SensorAERef.AeRefLV05Shutter = 1503;//5000;
    Ref->SensorAERef.AeRefLV05Gain = 496*7;//2; // 7.75x, 128 base 
	...
	*/	
	/*Ref->SensorAERef.AeRefLV05Shutter =720;//720;//820//720;//2195;
    Ref->SensorAERef.AeRefLV05Gain = 168;//168;//168;//640;//
    Ref->SensorAERef.AeRefLV13Shutter =404;//404;    
    Ref->SensorAERef.AeRefLV13Gain =166;//180;
	*/
	//1053;160;868;180;
